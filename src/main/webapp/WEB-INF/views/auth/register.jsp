                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user">
                                ...
                                <a href="${contextPath}/auth/login" class="btn btn-primary btn-user btn-block">
                                    Register Account
                                </a>
                                <hr>
                                <a href="${contextPath}/common/index" class="btn btn-google btn-user btn-block">
                                    <i class="fab fa-google fa-fw"></i> Register with Google
                                </a>
                                <a href="${contextPath}/common/index" class="btn btn-facebook btn-user btn-block">
                            ...
                            <div class="text-center">
                                <a class="small" href="${contextPath}/auth/login">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
